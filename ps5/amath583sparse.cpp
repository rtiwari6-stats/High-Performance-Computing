...
void mult(const COOMatrix& A, const Vector& x, Vector& y, size_t parts) { A.matvec(x, y); }      // Fix me (maybe)
void mult(const Vector& x, const COOMatrix& A, Vector& y, size_t parts) { A.t_matvec(x, y); }    // Fix me (maybe)
...
void mult(const CSRMatrix& A, const Vector& x, Vector& y, size_t parts) { A.matvec(x, y, parts); }      // Fix me (maybe)
void mult(const Vector& x, const CSRMatrix& A, Vector& y, size_t parts) { A.t_matvec(x, y); }    // Fix me (maybe)
...
void mult(const CSCMatrix& A, const Vector& x, Vector& y, size_t parts) { A.matvec(x, y); }      // Fix me (maybe)
void mult(const Vector& x, const CSCMatrix& A, Vector& y, size_t parts) { A.t_matvec(x, y, parts); }    // Fix me (maybe)
