...
std::complex<double> f(std::complex<double> x)  { return std::pow(x,6) + 13.0 * std::pow(x,4) - 11.0; }  // f(x) = x^6 + 13x^4 - 11
std::complex<double> fp(std::complex<double> x) { return 6.0 * std::pow(x,5) + 52.0 * std::pow(x,3); }  // derivative of f
